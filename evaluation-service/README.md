...
> 🛠 **LocalStack**
> Se estiver usando o ambiente de desenvolvimento com Docker/LocalStack, defina também as variáveis:
> ```bash
...
> AWS_REGION="us-east-1"
> ```
> O código agora detecta automaticamente endpoints base e configura o cliente AWS para apontar para o LocalStack, evitando erros de token inválido.
